...
*/
/*
    FileName: HpPcFactory.java
    Date: 2019/4/8
    Author: lq
*/
package com.lq186.demo.designpattern.factory.abst;

import com.lq186.demo.designpattern.factory.abst.keyboard.HpKeyboard;
import com.lq186.demo.designpattern.factory.abst.keyboard.IKeyboard;
import com.lq186.demo.designpattern.factory.abst.mouse.HpMouse;
import com.lq186.demo.designpattern.factory.abst.mouse.IMouse;

public final class HpPcFactory extends AbstractPcFactory {
