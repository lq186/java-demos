...
*/
/*
    FileName: MultiMethodSupplierFactory.java
    Date: 2019/4/8
    Author: lq
*/
...
public final class MultiMethodSupplierFactory {

    public static final ISupplier appleSupplier() {
        return new AppleSupplier();
    }

    public static final ISupplier originSupplier() {
        return new OriginSupplier();
    }

    public static final ISupplier carSupplier() {
